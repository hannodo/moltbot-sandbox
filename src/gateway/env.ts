...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.GITHUB_DEPLOY_KEY_FILE) envVars.GITHUB_DEPLOY_KEY_FILE = env.GITHUB_DEPLOY_KEY_FILE;
  if (env.GITHUB_REPO_SSH) envVars.GITHUB_REPO_SSH = env.GITHUB_REPO_SSH;
